...
public sealed class PhpRedisAdminManager
{
    ...
    public const string PathLocationsFileName = "stackroot-phpredisadmin.locations";
        ...
        string? phpVersionId = null)
    {
        ...
        if (pra.AccessMode == AccessMode.Path)
        {
            ...
            PersistPathModeNginxLocations(BuildPathModeNginxLocations(pra, appHtmlRoot, fcgiHost, fcgiPort, phpRc, phpVersionId));
            RemoveNginxConfig();
            return;
        }
