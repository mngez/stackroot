...
public sealed class PhpRedisAdminSettingsDialogViewModel : ViewModelBase
{
    private readonly PhpRedisAdminManager _manager;
    private readonly SettingsStore _settingsStore;
    private bool _enabled;
    private string _path = "phpredisadmin";
    ...
    public PhpRedisAdminSettingsDialogViewModel(
        PhpRedisAdminManager manager,
    ...
    private void Save()
    {
        ...
        _manager.ApplyConfig(new PhpRedisAdminConfigUpdate
        {
            Enabled = Enabled,
    ...
    {
        var segment = string.IsNullOrWhiteSpace(Path) ? "phpredisadmin" : Path.Trim('/');
        PreviewUrl = $"http://{AppDomain}/{segment}/";
    }
}

public sealed class CompatiblePhpOption
{
